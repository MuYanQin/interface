...
public class BigDecimalUtils {
     ...
     * @return 积
     * */
    public static BigDecimal multiplyPercent4(BigDecimal value) {
        return multiply(value, getPercent(), 4);
    }
    ...
    */ 
     ...
     * @Date: 2018/6/29 16:35
     */
    public static String getNotNullString2(BigDecimal bigDecimal){
        if(bigDecimal == null || bigDecimal.intValue() == 0){
            return "0.00";
        }else{
            return bigDecimal.toString();
    ...
    */ 
    ...
    public static BigDecimal getMin(BigDecimal ...values){
        BigDecimal min = null;
        int i = 0;
        for(BigDecimal val : values){
            if(i == 0){
                min = getNotNullBigDecimal(val);
            }else if(getNotNullBigDecimal(val).compareTo(min) < 0){
                min = getNotNullBigDecimal(val);
            }
            i++;
        }
