...
public class ArrayUtils {
    ...
    public static <T> List<T> addObj(List<T> ageComBorrList, Object age) {
        if(ArrayUtils.isNullOrLengthZero(ageComBorrList)){
            ageComBorrList = new ArrayList<>();
        }
        ageComBorrList.add((T) age);
        return ageComBorrList;
    }
}
